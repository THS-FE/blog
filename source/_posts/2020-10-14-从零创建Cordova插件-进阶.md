...
updated: 2020-10-14 23:09:50
---

# <span style="display:block;text-align:left;color:#1683fc;">l cordova开发进阶 </span>
...
#### 打开第三方Android SDK活动 如:[百度地图uri](http://lbsyun.baidu.com/index.php?title=uri/api/android)
```java
...
插件初始化到执行的过程执行顺序如下，依次是initialize、pluginInitialize、execute：
