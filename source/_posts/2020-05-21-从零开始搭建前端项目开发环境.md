...
接下来会先介绍一下几个常用工具（Babel 7.13.0，Browserslist 4.11.1, ESLint 7.26.0, EditorConfig）的核心概念、安装和配置，最后会结合 TypeScript + SASS + webpack5 的项目来说如何将它们整合起来形成一个完整的前端项目开发环境。 Here we go.
